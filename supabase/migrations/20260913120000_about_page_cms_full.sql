-- About page fully CMS: replace old section types with new ones
-- about-foundation → about-mission, about-why → about-team
-- Content structures updated to match original About.tsx design.
-- Images updated to Supabase Storage URLs.
--
...
BEGIN
  ...
  -- S01: About Intro (hero with two images)
