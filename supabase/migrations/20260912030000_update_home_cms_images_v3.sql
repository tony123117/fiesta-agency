...
-- Images have UUID filenames as uploaded

DO $$
DECLARE
  home_id UUID := 'bd69ce45-ca3f-46ce-8fee-39c33730d5df';
  img1 UUID := '1789237181004-3xhl7jh5r8c.JPG';
  img2 UUID := '1789237158612-mn2meeybu9o.JPG';
  img3 UUID := '1789237092060-8sq54jcdwr8.JPG';
BEGIN

  -- Hero: 4 slides - use 4 of the uploaded images
  ...
  -- Services Editorial: 10 services - use mix of uploaded images
  UPDATE sections SET content = '{
    "heading": "WHAT WE DO",
