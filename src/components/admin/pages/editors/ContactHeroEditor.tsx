...
export function ContactHeroEditor({ content, onChange }: { content: Record<string, unknown>; onChange: (c: Record<string, unknown>) => void }) {
  const data = content as unknown as ContactHeroContent;
  const update = (fields: Partial<ContactHeroContent>) => onChange({ ...data, ...fields });
